...
function db_multi_insert($tbl, $field_list, $val_list_of_list, $activity_id, $echo = true, $json = true) {
  ...
  if($activity_id!='0') {
  update_activity_status($activity_id);
  }
...
function update_user_session_id($db_id, $session_id) {
  ...
  $query1 = "SELECT id from tbl_login where user = $db_id";
